...
import com.immanlv.notes.feature_note.presentation.notes.components.NoteItem
import com.immanlv.notes.feature_note.presentation.notes.components.OrderSection
import com.immanlv.notes.feature_note.presentation.util.Screen
            ...
            LazyColumn(modifier = Modifier.fillMaxSize()) {
                items(state.notes.size) { index ->
                    NoteItem(
                        ...
                        modifier = Modifier
                            .fillMaxWidth()
                            .clickable { navController.navigate(Screen.AddEditNoteScreen.route + "?noteId=${state.notes[index].id}&noteColor=${state.notes[index].color}") },
                        onDeleteClick = {
